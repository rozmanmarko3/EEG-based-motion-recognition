...
\begin{figure}
    ...
    \end{center}
    \caption{Matriki zmede nevronskih mrež naučenih na podatkih fitriranih s filtrom z ničelno fazo(levo) in Butterworthovim filtrom(desno). Uporabljena metoda CPCC za epoho prvih štirih sekund za frekvenčni pas beta. V zelenih poljih vidna točnost za posamezna stanja. Od zgoraj navzdol: skrčena desna pest, skrečena leva pest, stanje mirovanja. }
...
Po razvoju pristopov na zbirkah podatkov smo implementirali sprotno razpoznavanje. Uporabili smo programsko opremo Lab Streaming Layer, da smo prenašali podatke iz napreave Quick-20 v okolje MATLAB. Tam smo podatke hranili. Vsako sekundo smo izračunali povezljivost in jo razvrstili. Rezultat razvrščanja smo izpisali na zaslon. Na natačnost sprotnega razvrščanja matrik povezljivosti ene osebe vpliva veliko stvari. Nanj vpliva razpoloženje osebe, namestitev naprave in sam dogodek ki ga razvrščamo. Točnost razvrščanja je padla, vendar smo pokazali da je le to mogoče.
