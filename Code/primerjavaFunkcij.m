...
mkdir(resultsFolder)
delete(fullfile(resultsFolder, '*.png'));
...
save(fullfile(resultsFolder,'results.mat'), 'resultsEEGLAB', 'resultsMY' );

%%
%CREATEFIGURE(ymatrix1)
%  YMATRIX1:  bar matrix data

%  Auto-generated by MATLAB on 30-Jun-2024 14:30:27
...
bar1 = bar([resultsEEGLAB, resultsMY]);
set(bar1(2),'DisplayName','Zero-Phase filter');
set(bar1(1),'DisplayName','Butterworth filter');
...
set(axes1,'XTick',[1 2 3 4 5],'XTickLabel',...
    {'0.1-4Hz','4-8Hz','8-13Hz','13-20Hz','20-40Hz'});
% Create legend
legend1 = legend(axes1,'show');
set(legend1,...
    'Position',[0.194175708713998 0.819940061094406 0.13853638103569 0.067047378698178]);
